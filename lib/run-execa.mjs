...
/**
 * @import { Options as ExecaOptions, Result } from 'execa';
 */
 ...
 * @returns {Promise<Result>} Result of a subprocess successful execution..
 *
 * @example
 * await runExeca('pnpm', ['run', 'build'], { cwd: './packages/core' });
 *
 * @example
 * const { stdout } = await runExeca('git', ['status', '--short'], { silent: true });
 */
